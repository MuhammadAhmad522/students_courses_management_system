...
class EnrollmentManagement
    ...
    def show_courses_enrolled_by_student
        ...
        if enrollments.empty?
            ...
            enrollments.each do |enrollment|
                # show student name
                student_name = @students.find do |student| 
                    if (student.getID == enrollment.get_student_id)
    ...
    def show_students_enrolled_in_course
        ...
        if enrollments.empty?
            ...
            enrollments.each do |enrollment|
                  # show course name
                  course_name = @courses.find do |course| 
                      if (course.getID == enrollment.get_course_id)
    ...
    def delete_course_enrollment
        ...
        print "Enter course ID: "
        course_id = gets.chomp.to_i
        enrollment = @enrollments.find { |enrollment| enrollment.get_student_id == student_id && enrollment.get_course_id == course_id }
        if enrollment
